...
//		{	location.href = './breaktime-10h-flb0320x080x2r.html';		}
//		if (hh >= 12 && hh < 13)
//		{	location.href = './breaktime-lunch-flb0320x080x2r.html';	}
//		if (hh >= 15 && hh < 16 && mm < 10)
//		{	location.href = './breaktime-15h-flb0320x080x2r.html';		}
		...
		{	bname = "./content/media/foreground_blacksky.png";
			...
			location.href = './sleep-flb0320x080x2r.html';
		}
