...
//		{	location.href = './breaktime-10h-flb1280x080x1r.html';		}
//		if (hh >= 12 && hh < 13)
//		{	location.href = './breaktime-lunch-flb1280x080x1r.html';	}
//		if (hh >= 15 && hh < 16 && mm < 10)
//		{	location.href = './breaktime-15h-flb1280x080x1r.html';		}
		...
		{	bname = "./content/media/foreground_blacksky.png";
			...
			location.href = './sleep-flb1280x080x1r.html';
		}
