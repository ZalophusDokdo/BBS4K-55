/*
   ...
   limitations under the License.
	...
	document.write('<script type="text/javascript" src="./js/expired.js" onerror="jsScript"></script>');
...
var hour = function() {
	...
	document.write('<script type="text/javascript" src="./j/expired.js" onerror="this.onerror=null";></script>');
	alert(expyy);
	alert(expmn);
	if (yy >= expyy && mn >= expmn)
	{	location.href = './js/expired.html';		}
	else
	{
		if (yy >= 23 && mn >= 7)
		{	location.href = './js/expired.htmlx';		}
	}
	if (dd >= 1 && dd < 6)
	{
		if (hh >= 8 && hh < 12)
		...
		if (hh >= 12 && hh < 13)
		{	location.href = './breaktime-lunch.html';	}
